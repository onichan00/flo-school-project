...
public class ProjectData {
    ...
    Project project1 = new Project("Project 1", bannerImage, 0, LocalDate.now(), "Test description");
    Project project2 = new Project("Project 2", bannerImage2, 1, LocalDate.now(), "Test description");
    Project project3 = new Project("Project 3", bannerImage, 0, LocalDate.now(), "Test description");
    Project project4 = new Project("Project 4", bannerImage2, 2, LocalDate.now(), "Test description");
