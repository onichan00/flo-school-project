        ...
        <div class="px-4 py-3 h-auto" v-if="selectedSettings" v-bind="selectedSettings">
          <div class="bg-white rounded-lg dark:bg-gray-700">
            <div class="flex flex-col text-left">
              ...
              <p class="text-md font-normal text-gray-600 pb-3">Deze informatie zal publiekelijk getoond worden dus wees voorzichtig met wat u deelt.</p>
            </div>
            ...
            <form class="h-fit pt-3">
              <div class="mb-2">
                ...
                <img class="mb-2 w-36 h-36 rounded-lg border-2" :src="require('@/assets/img/undraw_coffee_with_friends_3cbj.svg')" alt="Profielfoto">
              ...
              <div class="mb-4">
                <label for="description" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Bio</label>
