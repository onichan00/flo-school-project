    ...
    <div class="flex justify-between items-center pb-4  dark:bg-gray-900">
      ...
      <div id="dropdown"
        ...
        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
          ...
          <li>
            <a href="#"
               class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Email</a>
          </li>
          <li>
            <a href="#"
          ...
          <li>
            <a href="#" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Available</a>
          </li>
        </ul>
      </div>
